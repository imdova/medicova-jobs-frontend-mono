...
const SingleSeekerChart = () => {
  ...
  const jobs = generateRandomArray(
    data.userDataPerTime.counts.length,
    1,
    timeUnit == "daily" ? 1 : timeUnit == "weekly" ? 2 : timeUnit == "monthly" ? 8 : 20,
  ) || []
  ...
  return (
    <div className="rounded-lg bg-white p-3 shadow-sm">
      ...
      <ChartHeader
        ...
        setFilter={setFilter}
      />
      <div className="-mb-3 -ml-4 h-80 w-full">
        {isLoading ? (
...
export default SingleSeekerChart;
