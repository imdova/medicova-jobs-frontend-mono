...
type Category = "Companies" | "countries" | "categories";
const categories: Category[] = ["Companies", "countries", "categories"];
...
const EmployersChart = () => {
  ...
  const [category, setCategory] = useState<Category>("Companies");
      ...
      case "categories":
        return [
          ...
          },
          {
            name: "Jobs Posted",
            color: "#4A90E2", // Blue
            data: data.userDataPerCategory.resumeUploads,
          },
        ];
      default:
        return [];
  ...
  return (
    <div className="h-[calc(100%-190px)] max-h-96 rounded-lg bg-white p-3 shadow-sm">
      <div className="h-[190px]">
        <div className="flex items-center justify-between">
          <h1 className="mb-4 flex-1 p-2 text-2xl font-bold">
            Companies & Completed Profiles Trends
          </h1>
      ...
      <div className="-mb-3 -ml-4 h-full w-full">
        {isLoading ? (
