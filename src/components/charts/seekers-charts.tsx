...
const SeekerChart = () => {
  ...
  return (
    <div className="h-[calc(100%-190px)] rounded-lg bg-white p-3 shadow-sm">
       <div className="h-[190px]">
        <div className="flex items-center justify-between">
          <h1 className="mb-4 max-w-72 p-2 text-2xl font-bold">
            Seekers & Completed Profiles Trends
          </h1>
      ...
      <div className="-mb-2 -ml-4 h-full w-full">
        {isLoading ? (
