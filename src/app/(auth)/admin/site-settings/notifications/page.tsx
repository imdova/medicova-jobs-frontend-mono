        ...
        <div className="flex flex-col gap-4 md:flex-row">
          ...
          <div>
            <FormGroup>
              <FormControlLabel
                control={
                  <Switch
                    color="primary"
                    defaultChecked={defaultValues.reciveApplications}
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Switch
                    color="primary"
                    defaultChecked={defaultValues.reciveJobs}
                  />
                }
                className="mb-4 flex max-w-[350px] items-start"
                onChange={(event, checked) => {
              ...
              <FormControlLabel
                control={
                  <Switch
                    color="primary"
                    defaultChecked={defaultValues.reciveRecommendations}
                  />
                }
                className="mb-4 flex max-w-[350px] items-start"
                onChange={(event, checked) => {
            ...
            <Button
              variant="contained"
              LinkComponent={Link}
              href="/job-seeker/setting/details"
            >
              Update Email
            </Button>
          </div>
